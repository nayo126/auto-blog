...
<!-- INLINE_IMG -->
![bolt.newのロゴ設定3つの方法｜個人開発で差をつける - bolt.newのロゴとは？まず2つを混同しない](/auto-blog/inline-images/boltnew-3--0.jpg)
...
<!-- INLINE_IMG -->
![bolt.newのロゴ設定3つの方法｜個人開発で差をつける - 公式ロゴ（ブランドアセット）の入手と使用ルール](/auto-blog/inline-images/boltnew-3--1.jpg)
